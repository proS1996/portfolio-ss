...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn("inline-flex -auto rounded-md p-1 text-primary", className)}
    {...props}
  />
));
